...
import DocumentUploader from "@/component/panel/DocumentUploader.jsx";
...
export default function Verification({ params }) {
  ...
  const [step, setStep] = useState("residenceDocument");
  ...
  const handleNationality = async () => {
    ...
    try {
      const response = await APITemplate(
        "user/updateNonRegisterNationality",
        "POST",
        formData
      );
  ...
  const handleIdentityVerification = async () => {
    ...
    try {
      const response = await APITemplate(
        "user/updateNonRegisteredIdentityVerification",
        "POST",
        formData
      );
      if (response.success == true) {
  ...
  const handlePanDocumentData = async () => {
    ...
    const regex = /^(0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-(19|20)\d\d$/;
    if (!panData?.DOB || regex.test(DOB) == false) {
      newErrors.push("DOB");
      setErrors(newErrors);
    }
  ...
  const handleBankDocumentData = async () => {
    setErrors([]);
    setLoading(true);
    const newErrors = [];
    if (!bankData?.transactionPurpose) {
      newErrors.push("transactionPurpose");
      setErrors(newErrors);
    }
    if (!bankData?.transactionAmount) {
    ...
    const formData = new FormData();
    formData.append("transactionPurpose", bankData?.transactionPurpose);
    formData.append("transactionAmount", bankData?.transactionAmount);
    formData.append("verificationId", verification?._id);
    try {
      const response = await APITemplate(
        "user/updateBankDocumentData",
        "POST",
        formData
      );
      if (response.success == true) {
            ...
            >
              ...
              >
                <div className="d-flex gap-4 justify-content-between">
                  ...
                  {frontDocument && frontDocument != "" && (
                    <button
                      onClick={() => setStep("documentUploaded")}
                      className="btn btn-outline-dark"
                    >
              ...
              >
                <div className="d-flex gap-4 justify-content-between">
                  ...
                  {backDocument && backDocument != "" && (
                    <button
                      onClick={() => setStep("backdocumentUploaded")}
                      className="btn btn-outline-dark"
                    >
                      <i className="fa fa-arrow-right"></i>
                    </button>
                ...
                <div className="d-flex flex-column align-items-start  p-3">
                  <div className="d-flex gap-4 w-100 p-3">
                    <div className="d-flex flex-column gap-2 text-center w-100">
                      <h5 className="fw-light text-secondary p-1 badge bg-primary px-3 py-2 w-fit text-white mx-auto fw-bold">
                        Step 2 / 5
                      </h5>
                  ...
                  <div className="w-100 d-flex align-items-center w-100 flex-column gap-4 ">
                    ...
                    <div className="d-flex flex-wrap justify-content-center align-items-center gap-4">
                      ...
                      <button
                        onClick={() => setStep("uploadBackDocument")}
                  ...
                  <div className="w-100 d-flex align-items-center w-100 flex-column gap-3">
                    ...
                    <div className="w-100">
                      <label htmlFor="DOB">
                        {errors.includes("DOB") ? (
                          <span className="text-danger">
                            Date of Birth is should be in DD-MM-YYYY format
                          </span>
                        ) : (
                          "Date of Birth"
                        )}
            ...
            >
              ...
              >
                ...
                <div className="d-flex flex-column align-items-start gap-4 p-3">
                  <div className="d-flex gap-4 p-3 w-100">
                    <div className="d-flex flex-column gap-2 text-center w-100">
                      <h5 className="fw-light text-secondary p-1 badge bg-primary px-3 py-2 w-fit text-white mx-auto fw-bold"></h5>
                      <h3 className="fw-semibold">
                        How to make a PAN Document photo?
                      </h3>
                    </div>
                  </div>
              ...
              >
                <div className="d-flex gap-4 justify-content-between">
                  ...
                  {panDocument && panDocument != "" && (
                    <button
                      onClick={() => setStep("documentPanUploaded")}
                      className="btn btn-outline-dark"
                    >
                      <i className="fa fa-arrow-right"></i>
                    </button>
                ...
                <div className="d-flex flex-column align-items-start  p-3">
                  <div className="d-flex gap-4 p-3 w-100">
                    <div className="d-flex flex-column gap-2 text-center w-100">
                      ...
                      <h3 className="fw-semibold">PAN Card Document</h3>
                    </div>
                  </div>
                ...
                <div className="d-flex flex-column align-items-start  p-3">
                  ...
                  <div className="w-100 d-flex align-items-center w-100 flex-column gap-4 ">
                    ...
                    <div className="d-flex flex-wrap justify-content-center align-items-center gap-4">
                      ...
                      <button
                        onClick={() => setStep("PandocumentData")}
                        className="btn btn-primary btn-lg"
                      >
                        Confirm
                      </button>
                ...
                <div className="d-flex flex-column align-items-start gap-3 p-3 pt-0">
                  <div className="d-flex gap-4 w-100 p-3 pb-0">
                    <div className="d-flex flex-column gap-2 text-center w-100">
                      ...
                      <h3 className="fw-semibold">
                        Check and confirm your PAN Detials
                      </h3>
                    </div>
                  </div>
                ...
                <div className="d-flex flex-column align-items-start gap-4 p-3">
                  <div className="d-flex gap-4 p-3 w-100">
                    <div className="d-flex flex-column gap-2 text-center w-100">
                      ...
                      <h3 className="fw-semibold">
                        How to make a Bank Statement document photo?
                      </h3>
                    </div>
                  </div>
              ...
              >
                <div className="d-flex justify-content-between">
                  ...
                  {bankDocument && bankDocument != "" && (
                    <button
                      onClick={() => setStep("bankStatementUploaded")}
                      className="btn btn-outline-dark"
                    >
                      <i className="fa fa-arrow-right"></i>
                    </button>
                ...
                <div className="d-flex flex-column align-items-start  p-3">
                  <div className="d-flex gap-4 p-3 w-100">
                    <div className="d-flex flex-column gap-2 text-center w-100">
                      ...
                      <h3 className="fw-semibold">Bank Statement Document</h3>
                    </div>
                  </div>
                        ...
                        <input
                          ...
                          onChange={async (e) => {
                            ...
                            try {
                              ...
                              if (response.success == true) {
                                setStep("bankStatementUploaded");
                                setBankDocument(response?.data?.image);
                              }
                            } catch (error) {
                              enqueueSnackbar(error.message, {
                                variant: "error",
                ...
                <div className="d-flex flex-column align-items-start  p-3">
                  ...
                  <div className="w-100 d-flex align-items-center w-100 flex-column gap-4 ">
                    ...
                    <div className="d-flex flex-wrap justify-content-center align-items-center gap-4">
                      ...
                      <button
                        onClick={() => setStep("bankdocumentData")}
                        className="btn btn-primary btn-lg"
                      >
                        Confirm
                      </button>
                ...
                <div className="d-flex flex-column align-items-start gap-3 p-3 pt-0">
                  <div className="d-flex gap-4 w-100 p-3 pb-0">
                    <div className="d-flex flex-column gap-2 text-center w-100">
                      ...
                      <h3 className="fw-semibold">
                        Check and confirm your Bank Detials
                      </h3>
                    </div>
                  </div>
                  ...
                  <div className="w-100 d-flex align-items-center w-100 flex-column gap-3">
                    <div className="w-100">
                      ...
                      <input
                        ...
                        value={bankData?.transactionPurpose}
                        onChange={(e) => handlBankData(e)}
                      />
                    </div>
                    <div className="w-100">
                      <label htmlFor="lastName">
                      ...
                      <div className="input-group flex-nowrap align-items-end">
                        <input
                          ...
                          value={bankData?.transactionAmount}
                          onChange={(e) => handlBankData(e)}
                        />
                        {/* Select button here */}
                        <select
                    ...
                    <div className="d-flex flex-wrap w-100 align-items-center gap-4">
                      ...
                      <button
                        disabled={loading}
                        onClick={handleBankDocumentData}
                        className="btn btn-primary btn-lg flex-fill"
                      >
                        {loading && (
                          <span className="spinner-border spinner-border-sm"></span>
